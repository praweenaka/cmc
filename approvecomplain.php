                        ...
                        <nav class="tm-nav">
                            <ul>
                                ...
                                if ($_SESSION['UserName'] == "captain") {
                                    echo " <li><a href = \"approvecomplain.php\" style=\"color: yellow;\">Approve Complain</a></li>";
                                }
                ...
                <div class="flexslider flexslider-about effect2">
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-success" style="background-color:white">
                            ...
                            <div class="form-group" >
                                <div class="row ">
                                    <h3 class="box-title" style="color: black;margin-top: 60px;margin-left: 50px;"><b>Approve Complains</b></h3>
